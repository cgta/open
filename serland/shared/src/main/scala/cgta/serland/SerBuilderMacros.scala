...
trait SerBuilderMacros {
  ...
  def forSubs10[A, S1 <: A, S2 <: A, S3 <: A, S4 <: A, S5 <: A, S6 <: A, S7 <: A, S8 <: A, S9 <: A, S10 <: A]: SerClass[A] = macro SerBuilderMacrosImpl.forSubs10[A, S1, S2, S3, S4, S5, S6, S7, S8, S9, S10]
  def forSubs11[A, S1 <: A, S2 <: A, S3 <: A, S4 <: A, S5 <: A, S6 <: A, S7 <: A, S8 <: A, S9 <: A, S10 <: A, S11 <: A]: SerClass[A] = macro SerBuilderMacrosImpl.forSubs11[A, S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, S11]
  def forSubs12[A, S1 <: A, S2 <: A, S3 <: A, S4 <: A, S5 <: A, S6 <: A, S7 <: A, S8 <: A, S9 <: A, S10 <: A, S11 <: A, S12 <: A]: SerClass[A] = macro SerBuilderMacrosImpl.forSubs12[A, S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, S11, S12]
  def forSubs13[A, S1 <: A, S2 <: A, S3 <: A, S4 <: A, S5 <: A, S6 <: A, S7 <: A, S8 <: A, S9 <: A, S10 <: A, S11 <: A, S12 <: A, S13 <: A]: SerClass[A] = macro SerBuilderMacrosImpl.forSubs13[A, S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, S11, S12, S13]
  def forSubs14[A, S1 <: A, S2 <: A, S3 <: A, S4 <: A, S5 <: A, S6 <: A, S7 <: A, S8 <: A, S9 <: A, S10 <: A, S11 <: A, S12 <: A, S13 <: A, S14 <: A]: SerClass[A] = macro SerBuilderMacrosImpl.forSubs14[A, S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, S11, S12, S13, S14]
  def forSubs15[A, S1 <: A, S2 <: A, S3 <: A, S4 <: A, S5 <: A, S6 <: A, S7 <: A, S8 <: A, S9 <: A, S10 <: A, S11 <: A, S12 <: A, S13 <: A, S14 <: A, S15 <: A]: SerClass[A] = macro SerBuilderMacrosImpl.forSubs15[A, S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, S11, S12, S13, S14, S15]
  //Add more here when needed, also add them into the macro impls.
}