...
object TestOBinarySearch extends FunSuite {
  ...
  test("LastRepeated") {
    Assert.isEquals(0,OBinarySearch.lastRepeated(Array(1,2,2,3), 0))
    Assert.isEquals(2,OBinarySearch.lastRepeated(Array(1,2,2,3), 1))
    Assert.isEquals(2,OBinarySearch.lastRepeated(Array(1,2,2,3), 2))
    Assert.isEquals(3,OBinarySearch.lastRepeated(Array(1,2,2,3), 3))
    Assert.isEquals(4,OBinarySearch.lastRepeated(Array(1,2,2,3), 4))
  }
